...
from segmentation.network import PReLU, spatial_dropout, max_unpool
from segmentation.tools import *
...
class ICNet(Network):
    ...
    def set_input(self, img, img_name='input_img'):
        self.img, self.img_name = img, img_name
